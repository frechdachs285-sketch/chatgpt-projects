...
class _TrouserPageState extends State<TrouserPage> {
  ...
  void _calculate() {
    ...
    try {
      ...
      const pieceBuilder = TrouserPatternPieceBuilder(), waistbandBuilder = TrouserWaistbandBuilder(), shapedWaistbandBuilder = TrouserShapedWaistbandBuilder(), facingBuilder = TrouserShapedWaistbandFacingBuilder(), flyBuilder = TrouserFlyBuilder();
  ...
  @override Widget build(BuildContext context) {
    final draft = _draft, leftFront = _leftFront, rightFront = _rightFront, back = _back, waistband = _waistband, shapedWaistband = _shapedWaistband, shapedWaistbandFacing = _shapedWaistbandFacing, fly = _fly;
